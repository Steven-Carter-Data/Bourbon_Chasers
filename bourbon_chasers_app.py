...
if select == "Home":
    ...
    st.write('### Your Zone 3 Points are: ', z3number*1.5)
    st.write("""""")
    st.write("""""")
    z4number = st.number_input('Enter HR Zone 4 Time (x 2 multiplier):')
    st.write('### Your Zone 4 Points are: ', z4number*2)
    st.write("""""")
    st.write("""""")
    ...
    col1.image(image= 'tri8.jpg', use_column_width=True)
    col2.image(image= 'tri9.jpg', use_column_width=True)
    st.image(image= 'af_logo.png', use_column_width=False)
